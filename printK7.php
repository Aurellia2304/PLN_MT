...
<div class="sheet">
  ...
  <div class="header-section">
    <table class="frame">
      <tr>
        <td class="tug-title" rowspan="2" style="width:13%; vertical-align:middle;">
        ...
        <td class="title-cell" style="width:57%; padding: 4px;">
          ...
          <h1 style="font-size:16px; margin:2px 0;">BON PEMAKAIAN</h1>
        </td>
        <td class="tug-box" rowspan="2" style="width:30%; vertical-align:middle;">
          <div class="tug-number" style="font-size:15px;"><?= htmlspecialchars($k7['tug_number']) ?></div>
        </td>
      </tr>
      <tr>
